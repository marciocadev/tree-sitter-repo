...
if let x = y {} else if let x = z {} else {}
...
(source
  (if_let_statement
    ...
    value: (reference
      (reference_identifier))
    block: (block)
    else_if_let_block: (else_if_let_block
      name: (identifier)
      value: (reference
        (reference_identifier))
      block: (block))
...
================================================================================
(If Let) (Else If Let) (Else If) (Else)
================================================================================

if let x = y {} else if let x = z {} else if v {} else {}
